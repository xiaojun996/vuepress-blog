...
给你一个二维整数数组 <span style="background: #eee; color: #666;">envelopes</span> ，其中 <span style="background: #eee; color: #666;">envelopes[i] = [wi, hi]</span> ，表示第 <span style="background: #eee; color: #666;">i</span> 个信封的宽度和高度。
...
- <span style="background: #eee; color: #666;">1 <= envelopes.length <= 5000</span>
- <span style="background: #eee; color: #666;">envelopes[i].length == 2</span>
- <span style="background: #eee; color: #666;">1 <= wi, hi <= 104</span>
