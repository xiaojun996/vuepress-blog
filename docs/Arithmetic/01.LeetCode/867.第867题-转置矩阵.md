...
给你一个二维整数数组 <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">matrix</span>， 返回 <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">matrix</span> 的 转置矩阵 。
...
- <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">1 <= m, n <= 1000</span>
- <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">1 <= m \* n <= 10<sup>5</sup></span>
- <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">-10<sup>9</sup> <= matrix[i][j] <= 10<sup>9</sup></span>
