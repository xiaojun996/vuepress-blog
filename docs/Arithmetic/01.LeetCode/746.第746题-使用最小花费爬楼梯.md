...
数组的每个索引作为一个阶梯，第  <span style="background: #ddd; color: #666;">i</span> 个阶梯对应着一个非负数的体力花费值  <span style="background: #ddd; color: #666;">cost[i]</span>(索引从 0 开始)。
...
- <span style="background: #ddd; color: #666;">cost</span> 的长度将会在 <span style="background: #ddd; color: #666;">[2, 1000]</span>。
- 每一个 <span style="background: #ddd; color: #666;">cost[i]</span> 将会是一个 <span style="background: #ddd; color: #666;">Integer</span> 类型，范围为 <span style="background: #ddd; color: #666;">[0, 999]</span>。
