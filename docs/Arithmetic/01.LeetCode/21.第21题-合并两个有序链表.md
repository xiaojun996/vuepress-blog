...
- 两个链表的节点数目范围是 <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">[0, 50]</span>
- <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">-100 <= Node.val <= 100</span>
- <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">l1</span> 和 <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">l2</span> 均按 **非递减顺序** 排列
