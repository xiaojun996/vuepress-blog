...
- 两个链表的节点数目范围是 <span style="background: #eee; color: #666;">[0, 50]</span>
- <span style="background: #eee; color: #666;">-100 <= Node.val <= 100</span>
- <span style="background: #eee; color: #666;">l1</span> 和 <span style="background: #eee; color: #666;">l2</span> 均按 **非递减顺序** 排列
