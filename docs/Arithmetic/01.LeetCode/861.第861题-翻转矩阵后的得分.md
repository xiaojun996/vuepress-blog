...
有一个二维矩阵 <span style="background: #ddd; color: #666;">A</span> 其中每个元素的值为 <span style="background: #ddd; color: #666;">0</span> 或 <span style="background: #ddd; color: #666;">1</span> 。

移动是指选择任一行或列，并转换该行或列中的每一个值：将所有 <span style="background: #ddd; color: #666;">0</span> 都更改为 <span style="background: #ddd; color: #666;">1</span>，将所有 <span style="background: #ddd; color: #666;">1</span> 都更改为 <span style="background: #ddd; color: #666;">0</span>。
