...
给定长度为  <span style="background: #eee; color: #666;">2n</span>  的整数数组 <span style="background: #eee; color: #666;">nums</span> ，你的任务是将这些数分成  <span style="background: #eee; color: #666;">n</span> 对, 例如 <span style="background: #eee; color: #666;">(a1, b1), (a2, b2), ..., (an, bn)</span> ，使得从 <span style="background: #eee; color: #666;">1</span> 到  <span style="background: #eee; color: #666;">n</span> 的 <span style="background: #eee; color: #666;">min(ai, bi)</span> 总和最大。
...
- <span style="background: #eee; color: #666;">nums.length == 2 \* n</span>
- <span style="background: #eee; color: #666;">-104 <= nums[i] <= 10^4</span>
