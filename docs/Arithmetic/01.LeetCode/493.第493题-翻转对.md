...
给定一个数组 <span style="background: #ddd; color: #666;">nums</span> ，如果 <span style="background: #ddd; color: #666;">i < j</span> 且 <span style="background: #ddd; color: #666;">nums[i] > 2\*nums[j]</span> 我们就将 <span style="background: #ddd; color: #666;">(i, j)</span> 称作一个**重要翻转对**。
...
1. 给定数组的长度不会超过 <span style="background: #ddd; color: #666;">50000</span>。
