...
给定一个非负索引 <span style="background: #ddd; color: #666;">k</span>，其中 <span style="background: #ddd; color: #666;">k ≤ 33</span>，返回杨辉三角的第 <span style="background: #ddd; color: #666;">k</span> 行。
