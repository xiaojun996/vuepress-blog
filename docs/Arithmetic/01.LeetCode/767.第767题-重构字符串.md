...
给定一个字符串<span style="background: #ddd; color: #666;">S</span>，检查是否能重新排布其中的字母，使得两相邻的字符不同。
...
- <span style="background: #ddd; color: #666;">S</span> 只包含小写字母并且长度在<span style="background: #ddd; color: #666;">[1, 500]</span>区间内。
