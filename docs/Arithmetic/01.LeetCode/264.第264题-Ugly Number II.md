...
Given an integer <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">n</span>, return the <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">n^th</span> ugly number.
...
- <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">1 <= n <= 1690</span>
...
- 创建 **3** 个 指针，指针的值 **n2, n3, n5** 是代表有资格同 i 相乘的最 **小丑数的位置**
  ...
  - 一开始，丑数只有 **[1]**， **1** 可以同 **2, 3, 5** 相乘，取最小的 **1 × 2 = 2** <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">添加到丑数序列中</span>。
