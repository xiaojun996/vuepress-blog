...
给你一个整数数组 <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">nums</span> ，找到其中最长严格递增子序列的长度。

子序列是由数组派生而来的序列，删除（或不删除）数组中的元素而不改变其余元素的顺序。例如，<span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">[3,6,2,7]</span> 是数组 <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">[0,3,1,6,2,2,7]</span> 的子序列。
...
- <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">1 <= nums.length <= 2500</span>
