...
在由 <span style="background: #ddd; color: #666;">1 x 1</span> 方格组成的 <span style="background: #ddd; color: #666;">N x N</span> 网格  <span style="background: #ddd; color: #666;">grid</span> 中，每个 <span style="background: #ddd; color: #666;">1 x 1</span>  方块由 <span style="background: #ddd; color: #666;">/</span>、<span style="background: #ddd; color: #666;">\\</span> 或空格构成。这些字符会将方块划分为一些共边的区域。

（请注意，反斜杠字符是转义的，因此 <span style="background: #ddd; color: #666;">\\</span> 用 <span style="background: #ddd; color: #666;">"\\\\"</span>  表示。）。
...
- <span style="background: #ddd; color: #666;">1 <= grid.length == grid[0].length <= 30</span>
- <span style="background: #ddd; color: #666;">grid[i][j]</span> 是 <span style="background: #ddd; color: #666;">'/'</span>、<span style="background: #ddd; color: #666;">'\'</span>、或 <span style="background: #ddd; color: #666;">' '</span>。
