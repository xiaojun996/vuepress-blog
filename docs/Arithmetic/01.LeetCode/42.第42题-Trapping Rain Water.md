...
Given <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">n</span> non-negative integers representing an elevation map where the width of each bar is <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">1</span>, compute how much water it can trap after raining.
...
- <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">0 <= n <= 3 \* 104</span>
- <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">0 <= height[i] <= 105</span>
