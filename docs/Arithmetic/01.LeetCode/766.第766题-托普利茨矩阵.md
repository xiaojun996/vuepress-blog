...
给你一个 <span style="background: #ddd; color: #666;">m x n</span> 的矩阵 <span style="background: #ddd; color: #666;">matrix</span> 。如果这个矩阵是托普利茨矩阵，返回 <span style="background: #ddd; color: #666;">true</span> ；否则，返回 <span style="background: #ddd; color: #666;">false</span> 。
...
- <span style="background: #ddd; color: #666;">1 <= m, n <= 20</span>
- <span style="background: #ddd; color: #666;">0 <= matrix[i][j] <= 99</span>
