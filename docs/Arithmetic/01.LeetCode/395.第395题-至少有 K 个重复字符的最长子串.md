...
给你一个字符串 <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">s</span> 和一个整数 <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">k</span> ，请你找出 <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">s</span> 中的最长子串， 要求该子串中的每一字符出现次数都不少于 <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">k</span> 。返回这一子串的长度。
...
- <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">1 <= k <= 105</span>
