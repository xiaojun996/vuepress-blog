...
- <span style="background: #ddd; color: #666;">1 <= nums.length <= 10^5</span>
- <span style="background: #ddd; color: #666;">1 <= nums[i] <= 10^9</span>
- <span style="background: #ddd; color: #666;">0 <= limit <= 10^9</span>
