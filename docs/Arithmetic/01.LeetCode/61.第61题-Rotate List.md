...
Given the <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">head</span> of a linked list, rotate the list to the right by <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">k</span> places.
...
- The number of nodes in the list is in the range <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">[0, 500]</span> .
- <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">-100 <= Node.val <= 100</span> 
- <span style="background: #ddd; color: #666; padding: 3px 5px; border-radius: 2px;">0 <= k <= 2 \* 10<sup>9</sup></span> 
