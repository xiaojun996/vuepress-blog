...
给你链表的头结点 <span style="background: #ddd; color: #666;">head</span> ，请将其按 升序 排列并返回 排序后的链表 。

**进阶:**

- 你可以在 <span style="background: #ddd; color: #666;">O(n log n)</span> 时间复杂度和常数级空间复杂度下，对链表进行排序吗？
...
- 链表中节点的数目在范围 <span style="background: #ddd; color: #666;">[0, 5 * 104]</span> 内
- <span style="background: #ddd; color: #666;">-105 <= Node.val <= 105</span>
