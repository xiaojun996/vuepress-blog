...
- <span class="span-shadow" style="color: #42b983;">**\_\_webpack_require\_\_**</span> 这一块可以看上一篇文章 [浏览器中 commonjs 模块实现原理](https://xiaojun996.top/pages/79aeee/)
